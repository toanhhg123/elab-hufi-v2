...
export const updateSuggestNewDevice = async (updatedData: ISuggestNewDeviceType) => {    
	...
	const suggestNewDevice: ISuggestNewDeviceType = await API.put<ISuggestNewDeviceType, ISuggestNewDeviceType>(url, updatedData);
	return suggestNewDevice;
}
...
export const postSuggestNewDevice = async (newSuggestNewDeviceData: ISuggestNewDeviceType) => {
	...
	const newSuggestNewDevice = await API.post<ISuggestNewDeviceType[], ISuggestNewDeviceType>(url, [newSuggestNewDeviceData]);
...
export const postAcceptNewDevices  = async (newAcceptDevices: IAcceptNewDevicesType) => {    
	...
	const acceptNewDevice: IAcceptNewDevicesType = await API.post<IAcceptNewDevicesType, IAcceptNewDevicesType>(url, newAcceptDevices);
