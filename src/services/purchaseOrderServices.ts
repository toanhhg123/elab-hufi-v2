...
export const updatePurchaseOrder = async (id: String, updatedData: IPurchaseOrderType) => {
	const url = `${API_ENDPOINT}/api/PurchaseOrders/${id}`;
	const order: IPurchaseOrderType = await API.put<IPurchaseOrderType, IPurchaseOrderType>(url, updatedData);
	return order;
};
...
export const postPurchaseOrder = async (newOrderData: IPurchaseOrderType) => {
	const url = `${API_ENDPOINT}/api/PurchaseOrders`;
	const newOrder: IPurchaseOrderType = await API.post<IPurchaseOrderType, IPurchaseOrderType>(url, newOrderData);
	return newOrder;
};
