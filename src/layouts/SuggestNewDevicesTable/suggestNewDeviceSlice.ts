...
export const suggestNewDeviceSlice = createSlice({
  ...
  reducers: {
    ...
    setCurrentSuggestNewDeviceForm: (state: IsuggestNewDeviceState, action: PayloadAction<ISuggestNewDeviceType>) => {
      state.currentSuggestNewDeviceForm = action.payload
    },
    setCurrentSuggestNewDevice: (state: IsuggestNewDeviceState, action: PayloadAction<IListDeviceInSuggestNewDeviceType>) => {
