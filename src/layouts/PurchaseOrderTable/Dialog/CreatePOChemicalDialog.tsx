...
const CreatePOChemicalDialog: FC<{
    isOpen: boolean;
    onClose: any;
    handleSubmit: any;
    columns: ColumnType[];
    ...
    return <Dialog open={isOpen}>
        <DialogTitle textAlign="center"><b>Thêm thông tin nhập hoá chất</b></DialogTitle>
        <DialogContent>
...
export default React.memo(CreatePOChemicalDialog);